 ...
 * the minimum amount of change (the minimum sum of money) that you cannot create. The given coins can have any positive integer
...
public class NonConstructibleChange {
    public static int nonConstructibleChange(int[] coins) {
        ...
        int diference = 0;
        for (int coin : coins){
            if (coin > diference + 1) return diference + 1;
            diference += coin;
        }
